// PlanGateHandler.ts — Pure decision logic for the PlanGate PreToolUse hook.
// Per D3 handler-delegate pattern: no stdin reads, no process.exit, no side
// effects beyond appendEvent. See design.md §7.
